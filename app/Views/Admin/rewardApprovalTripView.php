...
<script>
    ...
    $(document).ready(function() {
        $("#table-reward").dataTableLib({
            url: window.location.origin + '/admin/service/reward/getDataApprovalRewardTrip/',
            ...
            buttonAction: [{
                    ...
                    style: 'info',
                    action: 'exportExcel',
                    url: window.location.origin + "/admin/reward/excelApprovalTrip"
                },
                {
                    display: 'Terima',
                    ...
                    style: "success",
                    action: "accept",
                    url: window.location.origin + "/admin/service/reward/actApproveRewardTrip",
                    message: "Approve"
                },
                {
                    display: 'Tolak',
                    ...
                    style: "danger",
                    action: "reject",
                    url: window.location.origin + "/admin/service/reward/actRejectRewardTrip"
                },
            ]
        });
    });
