                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 form-group">
                                        <div style="display: flex; align-items:center; justify-content:center; border:1px solid #DFE3E7; padding:10px;">
                                            <img id="product-image" class="img-fluid" style="display: none; height: 200px; width:200px;" alt="Blank">
                                        </div>
...
<script type="text/javascript">
        ...
        $('body').on('click', '.cke_dialog_ui_fileButton', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.cke_dialog_background_cover').css('display', 'none');
                    editor.insertHtml(`
        <img style="height:360px; width:400px" src="<?= getenv('UPLOAD_URL') . URL_IMG_CONTENT ?>` + response.data.results.content_image + `"/>
        `)
                },
    ...
    var stateContent = {
        ...
        addUrl: '/admin/service/content/actAddContent',
        selectedID: '',
        selectedOldImage: ''
    }
