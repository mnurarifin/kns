            ...
            <div class="modal-body card mb-0">
                <div class="">
                    ...
                    <div class="d-flex justify-content-around mb-1">
                        <div class="align-items-center content-followers">
                            <small class="text-center d-block mb-25 text-muted">Diberikan</small>
...
<script>
    ...
    $(document).ready(function() {
        $("#table-reward").dataTableLib({
            url: window.location.origin + '/admin/service/reward/getDataHistoryApprovalReward/',
            ...
            buttonAction: [{
                ...
                style: 'info',
                action: 'exportExcel',
                url: window.location.origin + "/admin/reward/excelHistory/<?= $netType; ?>"
            }, ],
        });
    });
