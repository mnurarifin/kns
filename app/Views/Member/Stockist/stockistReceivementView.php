    ...
    <div class="content-body">
      <div class="row">
        <div class="col-md-12 col-12">
          <a href="<?= BASEURL ?>/member/stockist/receivement/" class="btn <?= $type == '' ? 'btn-primary' : 'btn-outline-primary' ?> mr-1 mb-1">Pembelian Ke Perusahaan</a>
          <a href="<?= BASEURL ?>/member/stockist/receivement/stockist" class="btn <?= $type == 'stockist' ? 'btn-primary' : 'btn-outline-primary' ?> mr-1 mb-1">Pembelian Ke Master Stokis</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="btn_receive">
          ...
          <span class="d-none d-sm-block">Terima Stok</span>
        </button>
...
<script>
  $(function() {
    ...
    getTransactionPayment = () => {
      $("#table").dataTableLib({
        url: window.location.origin + "/member/stockist/get-transaction-delivered/",
        ...
        colModel: [{
            ...
            display: "Tanggal",
            name: "warehouse_transaction_status_datetime",
            align: "left",
          },
          {
            display: "Keterangan",
    ...
    $("#btn_receive").on("click", (el) => {
      $.ajax({
        url: "<?= BASEURL ?>/member/stockist/receive",
        type: "POST",
        data: {
          warehouse_transaction_id: $("#btn_receive").data("id")
        },
        success: (res) => {
