...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: '/service/content/detailContent/' + content_id,
            type: 'GET',
            async: false,
            dataType: 'json',
            success: function(response) {
                if (response.status == 200) {
                    ...
                    $('#select-category').val(content_content_category_id)
    ...
    var stateContent = {
        ...
        updateUrl: '/service/content/actUpdateBusinessPlan',
        ...
        $('body').on('click', '.cke_dialog_ui_fileButton', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.cke_dialog_background_cover').css('display', 'none');
                    editor.insertHtml(`
                <img style="height:360px; width:400px" src="<?= getenv('UPLOAD_URL') . URL_IMAGE_CONTENT ?>` +
