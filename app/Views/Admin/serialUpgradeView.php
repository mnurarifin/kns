                        ...
                        <div class="alert border-warning alert-dismissible mb-2 informSerial" role="alert">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-info">
                                    Serial yang bisa diaktifkan atau dinonaktifkan adalah serial yang belum digunakan.
                                </span>
                            </div>
                        </div>
    ...
    let app =
        Vue.createApp({
            ...
            methods: {
                ...
                detailSerial(serial) {
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            $('#detail-seller').html(res.data.administrator_name != null ? '<i class="bx bxs-detail success font-medium-5" data-toggle="tooltip"></i>' : '<i class="bx bxs-x-circle danger font-medium-5" data-toggle="tooltip"></i>');
                ...
                generateTable() {
                    $("#table").dataTableLib({
                        url: window.location.origin + '/admin/service/serial/getDataSerialUpgrade/<?= $tipeSerial; ?>',
                        selectID: 'serial_id',
                        colModel: [{
                                display: 'Serial',
                                name: 'serial_id',
                ...
                save() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: window.location.origin + '/admin/service/serial/sendUpgradeSerial',
                                method: 'POST',
                                data: {
                                    serial: serial,
                                },
