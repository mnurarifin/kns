<section id="investor">
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="card card-rounded">
                <div class="card-content py-1 px-1">
                    <button :class="['btn btn-outline-primary mr-1', type == 'daily' ? 'active' : '']" @click="changeTab('daily')">Harian</button>
                    <button :class="['btn btn-outline-primary mr-1', type == 'weekly' ? 'active' : '']" @click="changeTab('weekly')">Mingguan</button>
                    <button :class="['btn btn-outline-primary mr-1', type == 'monthly' ? 'active' : '']" @click="changeTab('monthly')">Bulanan</button>
                </div>
            </div>
        </div>
...
<script type="text/javascript" defer>
            ...
            methods: {
                ...
                generateInvestorTable() {
                    ...
                    $("#table-investor").dataTableLib({
                        url: window.location.origin + '/admin/service/investor/getDataReportInvestor/' + this.type + '/' + this.investor_id,
                        ...
                        colModel: [{
                            ...
                            {
                                display: 'Bagi Hasil (Rp.)',
                                name: 'investor_sharing',
                                sortAble: false,
                                align: 'right'
                            },
                        ],
    ...
    $(document).ready(function() {
        window.history.pushState("", "", '/admin/investor/report');
