          ...
          <div class="col-md-12 col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title cl-primary">Aktivasi Mitra Berhasil!</h4>
              </div>
                  ...
                  <div class="card border mb-1">
                    <div class="row py-3 align-center">
                      ...
                      <div class="col-sm-12 col-md-6 col-6 my-25">
                        <h5 class="cl-primary mb-2" style="line-height: 1.75rem;">Aktivasi Mitra Baru Berhasil diproses.</h5>
                        ...
                        <p class="mb-50 font-weight-bold"><span style="width: 100px;display: inline-block;">Upline </span>: <span class="text-black" id="text_upline_username"></span> (<span class="text-black" id="text_upline_member_name"></span>)</p>
                        <p class="mb-50 font-weight-bold"><span style="width: 100px;display: inline-block;">Posisi </span>: <span class="text-black" id="text_network_position"></span></p>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
  $(function() {
    ...
    checkRedirect = () => {
      ...
      if (params.get("upline_username")) {
        $("#text_upline_username").html(params.get("upline_username"))
      }
      if (params.get("upline_member_name")) {
        $("#text_upline_member_name").html(params.get("upline_member_name"))
      }
      if (params.get("network_position")) {
        $("#text_network_position").html(params.get("network_position") == "L" ? "Kiri" : "Kanan")
      }
    }
