            ...
            <form class="form form-horizontal" id="formAddUpdateReward">
                <div class="modal-body" style="max-height: 470px;">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label>Syarat Titik Kiri</label>
                            </div>
                            <div class="col-md-8 form-group">
                                <input class="form-control money" name="rewardCondLeft" id="rewardCondLeft" placeholder="Syarat Titik Kiri">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label>Syarat Titik Kanan</label>
                            </div>
                            <div class="col-md-8 form-group">
                                <input class="form-control money" name="rewardCondRight" id="rewardCondRight" placeholder="Syarat Titik Kanan">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <select name="admChargeType" class="form-control" id="admChargeType">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input class="form-control" type="number" name="admCharge" id="admCharge" placeholder="Jumlah Potongan">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#table-reward").dataTableLib({
            url: window.location.origin + '/admin/service/reward/getDataRewardRo/<?= $netType; ?>/',
            selectID: 'reward_id',
            colModel: [{
                    display: '',
                ...
                {
                    display: 'Titik Kiri',
                    name: 'reward_condition_node_left',
                    sortAble: false,
                    align: 'center'
                },
                {
                    display: 'Titik Kanan',
                    name: 'reward_condition_node_right',
                    sortAble: false,
                    align: 'center'
                },
                {
                    display: 'Potongan Admin',
                    name: 'reward_adm_charge_formatted',
                    sortAble: false,
                    align: 'center'
                },
                {
            ...
            buttonAction: [{
                ...
                },
                {
                    ...
                    style: "success",
                    action: "active",
                    url: window.location.origin + "/admin/service/reward/activeRewardRo/<?= $netType; ?>"
                },
                {
                    ...
                    style: "danger",
                    action: "nonactive",
                    url: window.location.origin + "/admin/service/reward/notActiveRewardRo/<?= $netType; ?>"
                },
                {
                    display: 'Hapus',
                    icon: 'bx bx-trash',
                    style: "danger",
                    action: "remove",
                    url: window.location.origin + "/admin/service/reward/removeRewardRo/<?= $netType; ?>",
                    message: 'Hapus'
                }
            ]
        })
    ...
    let stateReward = {
        ...
        addUrl: '/admin/service/reward/actAddRewardRo/<?= $netType; ?>',
        updateUrl: '/admin/service/reward/actUpdateRewardRo/<?= $netType; ?>',
        selectID: '',
        selectedOldImage: ''
    }
    ...
    function updateReward(reward) {
        ...
        $('#formAddUpdateReward input[name=rewardCondLeft]').val(reward.reward_condition_node_left);
        $('#formAddUpdateReward input[name=rewardCondRight]').val(reward.reward_condition_node_right);
