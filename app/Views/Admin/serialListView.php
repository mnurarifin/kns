        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
                                <button type="button" :disabled="addBtn" @click.prevent="addNumber" class="btn btn-primary">
                                    Tambah
                                </button>
                            </div>
                            <small class="text-muted">Pastikan pengguna mempunyai/aktif whatsapp.</small> <br>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-if="form.length  == 0">
                                            <td class="text-center" colspan="6" style="height:200px;"> Silahkan masukan nomor.</td>
                                        </tr>
                                        <tr v-else v-for="(item, index) in form">
                                            <td class="text-center"><a @click="deleteNumber(index)"> <i class="bx bx-trash danger"></i> </a>
                                            </td>
                                            <td class="text-left">
                                                <span>{{form[index].network_code}}</span>
                                            </td>
                                            <td class="text-left">
                                                <span>{{form[index].member_mobilephone}}</span>
                                            </td>
                                            <td><input class="form-control" type="number" v-model="form[index].serial_qty" min="1" max="100" style="max-width: 100%;"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" :disabled="form.length == 0" @click.prevent="save" class="btn btn-primary">
                        Kirim
                    </button>
                </div>
            </div>
        ...
        Vue.createApp({
            ...
            methods: {
                ...
                addNumber() {
                    ...
                    let find_stockist = app.stockist.find(el => el.member_id == $("#select_stockist").val())
                    ...
                    if (find_index == -1) {
                        if ($("#select_stockist").val()) {
                            this.form.push({
                                ...
                                network_code: find_stockist.member_network_code,
                                member_mobilephone: find_stockist.member_mobilephone,
                                serial_qty: 1,
                            })
                        }
                ...
                generateTable() {
                    $("#table-basic").dataTableLib({
                        url: window.location.origin + '/admin/service/serial/getDataSerial/<?= $tipeSerial; ?>/',
                        selectID: 'serial_id',
                        colModel: [{
                                display: 'Serial',
                                name: 'serial_id',
