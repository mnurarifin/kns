...
<script>
    $(function() {
        ...
        getTransactionPayment = () => {
            $("#table").dataTableLib({
                url: window.location.origin + "/member/transaction/get-transaction-warehouse-delivered/",
                ...
                colModel: [{
                    ...
                    },
                    {
                        ...
                        align: "left",
                        render: (params, data) => {
                            return params == 'courier' ? `${data.warehouse_transaction_delivery_courier_code} (${data.warehouse_transaction_delivery_courier_service}) - ${data.warehouse_transaction_awb}` : 'COD';
                        },
                    },
                ],
                options: {
        ...
        $("#btn_receive").on("click", (el) => {
            $.ajax({
                url: "<?= BASEURL ?>/member/transaction/receive-warehouse",
                type: "POST",
                data: {
