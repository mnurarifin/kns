                ...
                <div class="modal-body" style="max-height: 470px;">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" class="form-control" v-model="form.reward_duration" placeholder="Durasi Trip">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input id="reward_condition_point" class="form-control money" placeholder="Syarat Poin Kanan">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
    ...
    let app =
        Vue.createApp({
            ...
            methods: {
                ...
                generateTable() {
                    $("#table").dataTableLib({
                        url: window.location.origin + '/admin/service/reward/getDataRewardTrip/',
                        selectID: 'reward_id',
                        colModel: [{
                                display: 'Aksi',
                                name: 'reward_id',
                        ...
                        buttonAction: [{
                            ...
                            },
                            {
                                ...
                                style: "success",
                                action: "active",
                                url: window.location.origin + "/admin/service/reward/activeRewardTrip"
                            },
                            {
                                ...
                                style: "danger",
                                action: "nonactive",
                                url: window.location.origin + "/admin/service/reward/notActiveRewardTrip"
                            },
                            {
                                display: 'Hapus',
                                icon: 'bx bx-trash',
                                style: "danger",
                                action: "remove",
                                url: window.location.origin + "/admin/service/reward/removeRewardTrip",
                                message: 'Hapus'
                            }
                        ]
                    })
                ...
                save() {
                    ...
                    let actionUrl = this.data.btnAction == 'insert' ? window.location.origin +
                        '/admin/service/reward/addTrip' : window.location.origin + '/admin/service/reward/editTrip'
                    ...
                    formData.set('reward_duration', this.form.reward_duration);
