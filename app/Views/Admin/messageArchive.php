...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#table-village").dataTableLib({
            url: window.location.origin + '/admin/service/message/getDataMessage/archive',
            selectID: 'message_id',
            colModel: [{
                    display: '',
                    name: 'message_status',
                    ...
                    render: (params) => {
                        ...
                        let bxenvelopeopen =
                            '<div><img  class="mr-1" src="../../../app-assets/images/icon/envelope-open-regular-24.png" alt="avatar" height="18" width="18"></div>';
                        let icon = params == 1 ? bxenvelopeopen : '<i class="bx bx-envelope"></i>';
                        return icon;
                    }
                },
                {
