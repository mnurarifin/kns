							...
							<div class="card-body text-center">
								<div class="dropdown">
									<button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button"
										id="dropdownMenuButtonSec" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										2019
									</button>
												...
												<div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
													...
													<div class="widget-todo-item-action d-flex align-items-center">
														...
														<div class="avatar m-0 mr-50">
															<img src="../../../images/profile/user-uploads/social-2.jpg"
											...
											<li class="widget-todo-item">
												<div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
													...
													<div class="widget-todo-item-action d-flex align-items-center">
														...
														<div class="avatar m-0 mr-50">
															<img src="../../../images/profile/user-uploads/user-05.jpg"
																alt="img placeholder" height="32" width="32">
														</div>
														<div class="dropdown">
															<span
									...
									<ul class="widget-timeline mb-0">
										<li class="timeline-items timeline-icon-primary active">
											...
											<div class="timeline-content">
												<img src="../../../images/icon/pdf.png" alt="document" height="23" width="19"
