...
<script>
    ...
    $(document).ready(function() {
        $("#table-reward").dataTableLib({
            url: window.location.origin + '/admin/service/reward/getDataHistoryApprovalRewardRo/<?= $netType; ?>/',
            ...
            search: true,
            searchTitle: 'Pencarian Data Histori Approval Reward',
            searchItems: [{
                    display: 'Kode Mitra',
            ...
            buttonAction: [{
                ...
                style: 'info',
                action: 'exportExcel',
                url: window.location.origin + "/admin/reward/excelHistoryRo/<?= $netType; ?>"
            }, ],
        });
    });
    ...
    function detailQualified(idQualified) {
        ...
        $('#rewardNett').text('Rp. ' + idQualified.reward_qualified_reward_value)
