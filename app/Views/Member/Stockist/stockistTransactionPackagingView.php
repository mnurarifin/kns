...
<script>
    ...
    let app = Vue.createApp({
        ...
        methods: {
            ...
            generateTable() {
                $("#table").dataTableLib({
                    url: window.location.origin + '/member/stockist/get-member-transaction/paid',
                    ...
                    colModel: [{
                        ...
                        render: (params, args) => {
                            let resi = ''
                            if (args.stockist_transaction_delivery_method == 'courier') {
                                resi = `<a onclick="delivery(${params}, '${args.stockist_transaction_awb}')" title="Input Resi" data-toggle="tooltip" class="mx-25 cstmHover"> <i class="bx bx-edit-alt success"></i> </a>`;
                            } else {
                            ...
                            return `
                                <a onclick='app.printAlamat(${JSON.stringify(args)})' title="Print" data-toggle="tooltip" class="cstmHover d-none d-lg-inline-block"> <i class="bx bx-receipt warning"></i> </a>
                                <a onclick='app.printAlamatJS(${JSON.stringify(args)})' title="PrintJS" data-toggle="tooltip" class="cstmHover d-inline-block d-lg-none"> <i class="bx bx-receipt warning"></i> </a>
                                ${resi}
                                <a onclick="app.detailTrx('${params}')" title="Detail" data-toggle="tooltip" class="cstmHover"> <i class="bx bx-book info"></i> </a>
                            `;
                        }
                    }, {
                        display: "Tanggal",
                    ...
                    buttonAction: [{
                        ...
                        action: "accept",
                        message: 'mengirim',
                        url: window.location.origin + "/member/stockist/transaction-delivered"
                    }],
                    options: {
                        limit: [10, 25, 50, 100],
                        currentLimit: 10,
            ...
            printAlamat(data) {
                ...
                $.each(data.stockist_transaction_detail, (key, val) => {
                    detail_ += `
                                <tr>
                                    <td style="font-size: 20px; padding-left: 10px;">${val.stockist_transaction_detail_product_code}</td>
                                    <td style="font-size: 20px; padding-left: 10px;">${val.stockist_transaction_detail_product_name}</td>
                                    <td style="font-size: 20px;" align="center">${val.stockist_transaction_detail_quantity}</td>
                                    <td align="right" style="font-size: 20px; padding-right: 10px;">Rp ${val.stockist_transaction_detail_unit_price_formatted}</td>
                                    <td align="right" style="font-size: 20px; padding-right: 10px;">Rp ${val.stockist_transaction_detail_unit_nett_price_formatted}</td>
                                </tr>
                                `
                ...
                detail = `<table width="100%" border="1">
                                            <thead>
                                                <tr>
                                                    <th style="font-size: 20px; text-align: left;padding: 10px;">Kode Produk</th>
                                                    ...
                                                    <th align="right" style="font-size: 20px; padding-right: 10px; width: 150px">Subtotal</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ${detail_}
                                                <tr>
                                                    ...
                                                    <td align="right" style="font-size: 20px; padding-right: 10px;">${data.stockist_transaction_delivery_cost_formatted}</td>
                                                </tr>
                                                <tr>
                                                    <th align="right" style="font-size: 20px; padding-right: 10px;" colspan="4">Total</th>
                                                    <td align="right" style="font-size: 20px; padding-right: 10px;">Rp ${app.formatDecimal(parseInt(data.stockist_transaction_delivery_cost) + parseInt(total))}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                `
...
">
        ...
        <span>Tanggal Transaksi : <b>${data.stockist_transaction_datetime_formatted}</b></span>
    </div>
        <table style="width:100%">
            ...
            <tbody>
                <tr>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">Nama</th>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">:</th>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;"><b><?= COMPANY_NAME ?></b></th>
                    <th></th>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">Nama</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;"><b>${data.stockist_transaction_delivery_receiver_name}</b></th>
                </tr>
                <tr>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">No. HP</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;"><b><?= WA_CS_NUMBER ?></b></th>
                    <th></th>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">No. HP</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;"><b>${data.stockist_transaction_delivery_receiver_mobilephone}</b></th>
                </tr>
                <tr>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">Alamat</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;"><?= DELIVERY_WAREHOUSE_ADDRESS ?></th>
                    <th></th>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">Alamat</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">${data.stockist_transaction_delivery_receiver_address},
                        ${data.stockist_transaction_delivery_receiver_province_name},
                        ${data.stockist_transaction_delivery_receiver_city_name},
                        ${data.stockist_transaction_delivery_receiver_subdistrict_name}
                    </th>
                </tr>
                <tr>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">Kurir</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">${data.stockist_transaction_delivery_courier_code ? data.stockist_transaction_delivery_courier_code+` (`+data.stockist_transaction_delivery_courier_service+`)` : "COD"}</th>
                    <th></th>
                    <th style="font-weight: 400; font-size: 20px; text-align: left; vertical-align: top;">No. Resi</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;">:</th>
                    <th style="font-weight: 400; text-align: left; font-size: 20px; vertical-align: top;"><b>${data.stockist_transaction_delivery_courier_code ? data.stockist_transaction_delivery_awb : "-"}</b></th>
                </tr>
            </tbody>
        </table>
    </div>
